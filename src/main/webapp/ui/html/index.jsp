...
<head>
    ...
    <meta name="keywords" content="fly,layui,Music社区">
...
<div class="fly-header layui-bg-black">
    <div class="layui-container">
        <a class="fly-logo" href="/ui/html/index.jsp">
...
<div class="fly-panel fly-column">
    <div class="layui-container">
        ...
        <div class="fly-column-right layui-hide-xs">
            ...
            <a href="/ui/html/jie/add.html" class="layui-btn">发表新帖</a>
        </div>
                ...
                <ul class="fly-list">
                    <li>
                        <a href="user/home.html" class="fly-avatar">
                            <img src="/ui/usersmallhead/4545.png"
                                 alt="Eason">
                        </a>
                        <h2>
                            <a class="layui-badge">动态</a>
                            <a href="jie/detail.html">如何评价Eason的十面埋伏</a>
                        </h2>
                        <div class="fly-list-info">
                            ...
                            <span class="fly-list-kiss layui-hide-xs" title="悬赏飞吻"><i class="iconfont icon-kiss"></i> 99</span>
            ...
            <div class="fly-panel fly-signin">
                ...
                <div class="fly-panel-main fly-signin-main">
                    ...
                    <%
                        ...
                        System.out.println("11111111111111111111122222" + id);
                        ;
                    %>
                    <button class="layui-btn layui-btn-danger" onclick="window.location='/../adminById?id=<%=id%>;'">个人中心
                   <%-- <button class="layui-btn layui-btn-danger" onclick="window.location='/../adminById'">个人中心--%>
                    </button>
...
<script>
    ...
    layui.config({
        version: "3.0.0"
        , base: 'ui/res/mods/' //这里实际使用时，建议改成绝对路径
    }).extend({
        fly: 'index'
    }).use('fly');
</script>
